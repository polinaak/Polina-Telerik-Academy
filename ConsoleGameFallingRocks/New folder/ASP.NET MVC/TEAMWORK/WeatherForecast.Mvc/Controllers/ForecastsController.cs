...
namespace WeatherForecast.Mvc.Controllers
{
    public class ForecastsController : BaseController
    {
        ...
        {
            var towns = this.Data.Towns.All().OrderBy(x => x.Name).Select(TownViewModel.FromTown);
        ...
        public ActionResult Edit(int id)
        {
            ...
            if (forecast.ForecastDate <= DateTime.Now)
            {
                throw new Exception("Past forecasts cannot be edited!");
