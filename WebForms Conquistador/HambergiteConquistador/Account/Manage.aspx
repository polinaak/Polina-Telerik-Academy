<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="HambergiteConquistador.Account.Manage" %>
        ...
        <div class="span6">
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="fileUpload"><span><asp:Image runat="server" ID="ImageProfile" Width="180px" Height="180px" /></span>                   
                        <label>Change you profile picture</label>
                        <asp:FileUpload runat="server" ID="FileUploadPic" />
                        <asp:Button runat="server" ID="UploadButton" Text="Upload" OnClick="UploadButton_Click" CssClass="btn" />
                    </div>
                    <fieldset class="form-horizontal">
