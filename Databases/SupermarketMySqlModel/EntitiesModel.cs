...
{
	public partial class SupermarketMySqlContext : OpenAccessContext, ISupermarketMySqlContextUnitOfWork
	{
		...
		public SupermarketMySqlContext(string connection)
		...
		public SupermarketMySqlContext(string connection, MetadataSource metadataSource)
			:base(connection, backend, metadataSource)
		{ }
	...
	public interface ISupermarketMySqlContextUnitOfWork : IUnitOfWork
	{
